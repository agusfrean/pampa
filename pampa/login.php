...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email === $valid_email && $password === $valid_password) {
        ...
        header("Location: dashboard.php"); // Redirige a otra página si el login es correcto
        exit();
    } else {
...
<body class="d-flex justify-content-center align-items-center vh-100">
    <div class="login-container col-10 col-sm-8 col-md-6 col-lg-4 col-xl-3 p-3 p-md-5 mt-5 py-5">
        <div class="row justify-content-center">
            <div>
                ...
                <h3 class="text-center pt-5 mt-5">Log In</h3>
                <form action="login.php" method="POST">
                    ...
                    <?php endif; ?>
                    <button type="submit" class="btn btn-login mt-5">Ingresar</button>
                </form>
                <div class="text-center link-signup mt-3">
